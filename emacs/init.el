...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yaml-mode dockerfile-mode dmenu desktop-environment exwm orderless vertico which-key doom-modeline doom-themes vterm rainbow-delimiters no-littering auto-package-update use-package cmake-mode)))
(custom-set-faces
